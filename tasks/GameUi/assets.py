...
class GameUiAssets: 
	...
	# 探索前往六道之门 
	I_EXPLORATION_GOTO_SIX_GATES = RuleImage(roi_front=(933,637,44,45), roi_back=(144,611,958,102), threshold=0.65, method="Template matching", file="./tasks/GameUi/page/page_exploration_goto_six_gates.png")
	# 探索前往契灵之境 
